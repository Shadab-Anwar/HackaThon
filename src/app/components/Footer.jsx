...
<footer class="w-full text-gray-700 bg-gray-100 body-font">
    <div
        ...
        <div class="flex-shrink-0 w-64 mx-auto text-center pl-16 md:mx-0 md:text-left">
            <a class="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
                
            </a>
            <p class="mb-3 text-sm font-medium tracking-widest text-gray-900 uppercase title-font">Social Media</p>
            <div class="mt-4">
        ...
        <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
            <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <nav class="mb-10 list-none">
                    <li class="mt-3">
                        <a class="text-gray-500 cursor-pointer hover:text-gray-900">Our Team</a>
                    </li>
                    {/* <li class="mt-3">
                        <a class="text-gray-500 cursor-pointer hover:text-gray-900">Careers</a>
                    </li> */}
                    <li class="mt-3">
                        <a class="text-gray-500 cursor-pointer hover:text-gray-900">How it works ?</a>
                    </li>
                </nav>
            </div>
            <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <nav class="mb-10 list-none">
                    ...
                    <li class="mt-3">
                        <a class="text-gray-500 cursor-pointer hover:text-gray-900">Updates</a>
                    </li>
                </nav>
            </div>
            <div class="w-full px-4 lg:w-1/4 md:w-1/2">
            ...
            <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <nav class="mb-10 list-none">
                    ...
                    <li class="mt-3">
                        <a class="text-gray-500 cursor-pointer hover:text-gray-900">arka2005dey@gmail.com</a>
                    </li>
                    <li class="mt-3">
                        <a class="text-gray-500 cursor-pointer hover:text-gray-900">+91-9038528939</a>
                    </li>
                </nav>
            </div>
        </div>
    ...
    <div class="bg-gray-300">
        <div class="container px-5 py-4 mx-auto">
            <p class="text-sm text-gray-700 capitalize xl:text-center">© 2024 Made with Love by Team SIneWave</p>
        </div>
    </div>
</footer>
