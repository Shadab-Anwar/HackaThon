        ...
        <div class="bg-white rounded-lg shadow-lg p-5 md:p-20 mx-2">
            <div class="text-center">
                <h2
                    ...
                    Chat <span class="text-indigo-600">Bot</span>
                </h2>
                <h3 class='text-xl md:text-3xl mt-10'>Coming Soon</h3>
                <p class="text-md md:text-xl mt-10"><a class="hover:underline" href="#">Chat Bot</a> is a website help
                    you provide simple
            ...
            <div class="flex flex-wrap mt-10 justify-center">
                ...
                <div class="m-3">
                    <a href="#" title="Quicktoolz On Facebook"
                        ...
                        <span class="mx-auto">G-Mail</span>
                    </a>
                </div>
            </div>
        </div>
